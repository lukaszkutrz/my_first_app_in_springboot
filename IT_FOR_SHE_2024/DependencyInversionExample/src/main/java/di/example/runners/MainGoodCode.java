...
import di.example.implementations.BookReadersPresentation;
import di.example.implementations.ShowAsDiagram;
import di.example.implementations.ShowAsText;
import di.example.implementations.ShowInExcel;


public class MainGoodCode {

    public static void main(String[] args) {
        
        BookReadersPresentation dataPresenter = new ShowAsText();
    ...
    public static void showDataAboutBooksPerPersonForEachYear(BookReadersPresentation readersData) {
    ...
    public static void showDataAboutPersonsWhoHaventReadAnyBook(BookReadersPresentation readersData) {
    ...
    public static void showDataAboutBooksPerPersonForEachYearDataSet2(BookReadersPresentation readersData) {
    ...
    public static void showDataAboutPersonsWhoHaventReadAnyBookDataSet2(BookReadersPresentation readersData) {
